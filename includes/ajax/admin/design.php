...
try {
	...
	$_POST['system_wallpaper'] = ($_POST['system_wallpaper_default'])? '' : $_POST['system_wallpaper'];
	...
	$db->query(sprintf("UPDATE system_options SET 
		...
		css_custome_css = %s,
		custome_js_header = %s,
		custome_js_footer = %s ", secure($_POST['system_logo']), secure($_POST['system_wallpaper_default']), secure($_POST['system_wallpaper']), secure($_POST['system_random_profiles']), secure($_POST['system_favicon_default']), secure($_POST['system_favicon']), secure($_POST['system_ogimage_default']), secure($_POST['system_ogimage']), secure($_POST['css_customized']), secure($_POST['css_background']), secure($_POST['css_link_color']), secure($_POST['css_header']), secure($_POST['css_header_search']), secure($_POST['css_header_search_color']), secure($_POST['css_btn_primary']), secure($_POST['css_menu_background']), secure($_POST['css_custome_css']), secure($_POST['custome_js_header']), secure($_POST['custome_js_footer']) )) or _error(SQL_ERROR_THROWEN);
