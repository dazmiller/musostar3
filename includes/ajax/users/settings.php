...
try {
	...
	switch ($_GET['edit']) {
		...
		case 'basic':
			...
			/* valid inputs */
			if(!isset($_POST['firstname']) || !isset($_POST['lastname']) || !isset($_POST['gender']) || !isset($_POST['birth_month']) || !isset($_POST['birth_day']) || !isset($_POST['birth_year']) ||  !isset($_POST['biography'])  || !isset($_POST['website'])  ) {
			//	_error(400);
			}
			$user->settings($_GET['edit'], $_POST);
