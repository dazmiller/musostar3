            ...
            <div class="profile-header">
                ...
                <div class="profile-cover-wrapper">
                    {if $profile['user_cover_id']}
                        <img class="js_lightbox" style="top: {$profile['user_cover_position']}" data-init-position="{$profile['user_cover_position']}" data-id="{$profile['user_cover_id']}" data-image="{$system['system_uploads']}/{$profile['user_cover']}" data-context="album" src="{$system['system_uploads']}/{$profile['user_cover']}" alt="{$profile['user_firstname']} {$profile['user_lastname']}">
                    {/if}
                ...
                <div class="profile-avatar-wrapper">
                    <img {if !$profile['user_picture_default']} class="js_lightbox" data-id="{$profile['user_picture_id']}" data-image="{$profile['user_picture_full']}" data-context="album" {/if} src="{$profile['user_picture']}" alt="{$profile['user_firstname']} {$profile['user_lastname']}">
                    ...
                    {if $profile['user_id'] == $user->_data['user_id']}
                        ...
                        <div class="profile-avatar-crop {if $profile['user_picture_default']}x-hidden{/if}">
                    ...
                    {if $user->_logged_in}
                        {if $user->_data['user_id'] != $profile['user_id']}
                            ...
                            <div class="btn-group">
                                ...
                                {/if}
                                <button type="button" class="btn btn-default js_chat-start" data-uid="{$profile['user_id']}" data-name="{$profile['user_firstname']} {$profile['user_lastname']}" data-link="{$profile['user_name']}">
                                    <i class="fa fa-comments"></i> {__("Message")}
                                </button>
                                <div class="btn-group">
                        ...
                        {else}
                            <a href="{$system['system_url']}/settings/profile" class="btn btn-default">
                                <i class="fa fa-pencil-alt"></i> {__("Update Info")}
                            </a>
                        {/if}
                    {/if}
                </div>
...
<!--
                                        ...
                                        {foreach $custom_fields['basic'] as $custom_field}
                                            {if $custom_field['value']}
                                                <li>
                                                    ...
                                                    <a href="{$system['system_url']}/search/hashtag/{$custom_field['value']}"> {$custom_field['value']}</a>
                                                </li>
                                            {/if}
                                        {/foreach}
                                    </ul>
                        ...
                        {if count($profile['photos']) > 0}
                            <div class="panel panel-default panel-photos">
                                <div class="panel-heading">
                                    <i class="fa fa-file-image fa-fw text-info"></i> <a href="{$system['system_url']}/{$profile['user_name']}/photos">{__("Photos")}</a>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
