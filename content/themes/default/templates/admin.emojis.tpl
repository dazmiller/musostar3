    ...
    {elseif $sub_view == "add"}
        <div class="panel-body">
            <div class="alert alert-warning">
                ...
                <div class="text pt5">
                    {__("Musostar uses Twemoji Awesome and you can check")} <a target="_blank" href="https://www.webpagefx.com/tools/emoji-cheat-sheet/">{__("Emoji Cheat Sheet")}</a>  {__("for the Emojis, You must replace underscores with hyphens, For example: :hatching_chick: for pattern and hatching-chickas for class")}.
                </div>
            </div>
