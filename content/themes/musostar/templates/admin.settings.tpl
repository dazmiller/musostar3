    ...
    <div class="panel-body">
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=general_settings">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Example: social, Musostar, social site")}
                                </span>
                            </div>
                        </div>
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=features_settings">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Users can write articles or only admins/moderators")}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Turn the browser notifications On and Off")}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Turn the noty notifications On and Off")} (<a target="_blank" href="{$system['system_url']}/content/themes/{$system['theme']}/images/noty_notification.png">{__("preview")}</a>)
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">
                                    {__("Turn the cookie consent notification On and Off")}
                                </span>
                            </div>
                        </div>
            ...
            <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=posts">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            {__("Turn the poll posts On and Off")}
                        </span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            {__("Turn the post translation On and Off")}
                        </span>
                    </div>
                </div>
        ...
        {elseif $sub_view == "registration"}
            ...
            <ul class="nav nav-tabs admin mb20">
                <li class="active">
                    <a href="#General" data-toggle="tab">
                        <i class="fa fa-sign-in-alt fa-fw mr5"></i><strong class="pr5">{__("General")}</strong>
                    </a>
                </li>
                <li>
                    <a href="#Social" data-toggle="tab">
                        <i class="fab fa-facebook fa-fw mr5"></i><strong class="pr5">{__("Social Login")}</strong>
                    </a>
                </li>
                <li>
                    <a href="#Invitation" data-toggle="tab">
                        <i class="far fa-handshake fa-fw mr5"></i><strong class="pr5">{__("Invitation Codes")}</strong>
                    </a>
                </li>
            </ul>
            <!-- tabs nav -->
                ...
                <div class="tab-pane" id="Invitation">
                    ...
                    <div class="text-center text-readable mb20">
                        <button data-toggle="modal" data-url="admin/invitations.php?do=generate" class="btn btn-success">
                            <i class="fa fa-handshake"></i> {__("Generate New Code")}
                        </button>
                    </div>
                    <div class="divider"></div>
                        ...
                        <table class="table table-striped table-bordered table-hover js_dataTable">
                            ...
                            <tbody>
                                {foreach $rows as $row}
                                    <tr>
                                        <td>{$row['code_id']}</td>
                                        <td><span class="label label-default text-bg">{$row['code']}</span></td>
                                        <td>
                                            {if $row['valid']}
                                        ...
                                        <td>
                                            <span data-toggle="tooltip" data-placement="top" title='{__("Send to email")}'>
                                                <button data-toggle="modal" data-url="admin/invitations.php?do=prepare_email&code={$row['code']}" class="btn btn-xs btn-primary">
                                                    <i class="fa fa-envelope"></i>
                                                </button>
                                            </span>
                                            <button data-toggle="tooltip" data-placement="top" title='{__("Delete")}' class="btn btn-xs btn-danger js_admin-deleter" data-handle="invitation_code" data-id="{$row['code_id']}">
            ...
            <ul class="nav nav-tabs admin mb20">
                ...
                <li>
                    <a href="#Notifications" data-toggle="tab">
                        <i class="fa fa-envelope-open fa-fw mr5"></i><strong class="pr5">{__("Email Notifications")}</strong>
                    </a>
                </li>
            </ul>
            <!-- tabs nav -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control selectpicker" name="uploads_quality">
                                    <option value="high" {if $system['uploads_quality'] == "high"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-battery-full fa-2x fa-fw'></i></div><div class='text'><b>{__("High Quality")}</b><br>{__("High quality photos with low compression")}</div></div>">{__("High Quality")}</option>
                                    <option value="medium" {if $system['uploads_quality'] == "medium"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-battery-half fa-2x fa-fw'></i></div><div class='text'><b>{__("Medium Quality")}</b><br>{__("Medium quality photos with medium compression")}</div></div>">{__("Medium Quality")}</option>
                                    <option value="low" {if $system['uploads_quality'] == "low"}selected{/if} data-content="<div class='option'><div class='icon'><i class='fa fa-battery-empty fa-2x fa-fw'></i></div><div class='text'><b>{__("Low Quality")}</b><br>{__("Low quality photos with high compression")}</div></div>">{__("Low Quality")}</option>
                                </select>
                                <span class="help-block">
                                    {__("High quality photos will use larger space and vise versa")}
                                </span>
                            </div>
                        </div>
