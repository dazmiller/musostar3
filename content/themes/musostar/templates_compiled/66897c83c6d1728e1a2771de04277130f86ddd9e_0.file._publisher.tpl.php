<?php
/* Smarty version 3.1.32, created on 2018-12-18 07:11:20
  from 'C:\xampp\htdocs\musostar3\content\themes\musostar\templates\_publisher.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c189d98eaf7d1_14925702',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '66897c83c6d1728e1a2771de04277130f86ddd9e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\musostar3\\content\\themes\\musostar\\templates\\_publisher.tpl',
      1 => 1542671623,
      2 => 'file',
    ),
  ),
...
function content_5c189d98eaf7d1_14925702 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <ul class="publisher-tabs clearfix">
        <li>
            <span class="active js_publisher-tab" data-tab="post">
                <i class="fa fa-pencil-alt fa-fw"></i> <span class="hidden-xs"><?php echo __("Write");?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['system']->value['photos_enabled']) {?>
            <li>
                <span class="js_publisher-tab" data-tab="album">
                    <i class="fa fa-images fa-fw"></i> <span class="hidden-xs"><?php echo __("Create");?>
</span> <?php echo __("Album");?>

                </span>
            </li>
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['system']->value['polls_enabled'] || ($_smarty_tpl->tpl_vars['system']->value['market_enabled'] && $_smarty_tpl->tpl_vars['_handle']->value != "group" && $_smarty_tpl->tpl_vars['_handle']->value != "event") || ($_smarty_tpl->tpl_vars['system']->value['blogs_enabled'] && $_smarty_tpl->tpl_vars['_handle']->value != "page" && $_smarty_tpl->tpl_vars['_handle']->value != "group" && $_smarty_tpl->tpl_vars['_handle']->value != "event") || $_smarty_tpl->tpl_vars['system']->value['videos_enabled'] || $_smarty_tpl->tpl_vars['system']->value['audio_enabled'] || $_smarty_tpl->tpl_vars['system']->value['file_enabled']) {?>
        <li class="dropdown">
...
/blogs/new<?php if ($_smarty_tpl->tpl_vars['_handle']->value == 'page') {?>?page_id=<?php echo $_smarty_tpl->tpl_vars['_id']->value;
}?>">
                ...
                <?php if ($_smarty_tpl->tpl_vars['system']->value['videos_enabled']) {?>
                    <li>
                        <span class="publisher-tools-attach js_publisher-tab" data-tab="video">
                            <i class="fa fa-video fa-fw js_x-uploader" data-handle="publisher" data-type="video"></i> <?php echo __("Add Video");?>
